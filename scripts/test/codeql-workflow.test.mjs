...
test("CodeQL workflow targets the available self-hosted runner fallback label", () => {
  assert.match(workflow, /runs-on:\s*\[\s*self-hosted,\s*Linux,\s*X64,\s*github\+self-hosted\s*\]/);
});
