...
export function normalizeCommandRequest(value) {
  ...
  const normalized = {
    ...
    command_id: request.command_id
      ? requireBoundedString(request.command_id, 'command_id', { max: 128, pattern: SESSION_ID_PATTERN })
      : randomUUID(),
    session_id: requireBoundedString(request.session_id, 'session_id', {
      max: 128,
