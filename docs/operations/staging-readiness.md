...
Current `main` SHA: `1e4be773d73b568ceabdfb2651e4727c696d1dfb` (2026-07-16).
...
| SPDX SBOM | VERIFIED | `validate` run `29468958977`; `z-platform-sbom` ID `8364711825`; `z-platform-sbom.spdx.json` ID `8364710149` | Artifact digests were not re-fetched in this pass; artifacts are bound only to `1e4be773d73b568ceabdfb2651e4727c696d1dfb`. |
| Dependency and provenance policy | VERIFIED | `operations` run `29468958979`, success; `sbom-spdx-json` ID `8364198676`, 2026-07-16 | Artifact digest was not re-fetched in this pass; valid only for `1e4be773d73b568ceabdfb2651e4727c696d1dfb`. |
...
| Main security-alert state | IMPLEMENTED | CodeQL Advanced run `29468958931` passed on `1e4be773d73b568ceabdfb2651e4727c696d1dfb`; Dependabot alert state was not re-fetched with authenticated API access | Passing workflows do not by themselves prove alert closure. |
...
Remote `origin/main` SHA: `1e4be773d73b568ceabdfb2651e4727c696d1dfb` (merge PR #55, 2026-07-16).
