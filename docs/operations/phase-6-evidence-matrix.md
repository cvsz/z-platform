...
| Current `main` evidence (`0f181f19b2a53473af96fa5790c1191d4ddc4ae9`) | Seven-service topology and release gates | Runs `29468958977`, `29468958979`, and `29468958931` pass; smoke artifact `8364578530`; SBOM artifacts `8364711825`, `8364710149`; provenance artifact `8364198676` | GitHub Actions / isolated Compose | VERIFIED |
...
| CodeQL Advanced self-hosted runner lane | Self-hosted runner, broader query suite configuration, explicit language toolchain setup, and `github+self-hosted` fallback label | Workflow-shape regression test covers `runs-on: [self-hosted, Linux, X64, github+self-hosted]`, `security-and-quality` config loading, and setup ordering for Node/pnpm/Go/Python analysis | Repository / self-hosted runner | IMPLEMENTED |
