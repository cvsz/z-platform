...
| Current `main` evidence (`d53bc75779fd5d877623848c0bfd283644bde960`) | Seven-service topology and release gates | PR #69 runs `29625724483`, `29625724479`, `29625724469`, and `29625724468` passed; deployed-smoke and CodeQL passed on the release candidate | GitHub Actions / isolated Compose | VERIFIED |
