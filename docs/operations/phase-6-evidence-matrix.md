...
| Current `main` evidence (`28f96eb8946ee700b3a15f13d7e8c82ed3aee8af`) | Seven-service topology and release gates | Runs `29468958977`, `29468958979`, and `29468958931` pass; smoke artifact `8364578530`; SBOM artifacts `8364711825`, `8364710149`; provenance artifact `8364198676` | GitHub Actions / isolated Compose | VERIFIED |
