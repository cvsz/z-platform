...
- `GET /` serves the static accessible chat shell.
...
Run `npm test` in this directory to check health, gateway-only chat forwarding, model catalog loading, streaming forwarding, tenant scoping, conversation IDs, usage correlation, session expiry, logout, and gateway URL normalization.
