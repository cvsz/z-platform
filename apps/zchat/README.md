...
- `GET /` serves the static accessible chat shell with transcript, history sidebar, conversation title editor, prompt templates, export controls, theme toggle, composer, model picker, new chat, retry, clear, and logout controls.
